...
const FormAsistencia = (props) => {
    ...
    const fetchDatos = (id) => {
        ...
        axios.get(url)
            .then((response) => {
                ...
                if((objseguimiento.hr_llegada)!='F' && (objseguimiento.hr_salidas)===null){
    ...
    const enviarDatos = () => {
        ...
        if (insert === true)  {
            ...
            if(hr_llegada !=='CH' && hr_salidas === " "){
                insertarAsistencia(params);
            }else if(hr_llegada ==='CH' && hr_salidas !== " "){
                actualizarAsistencia(params);
            }
    ...
    const actualizarAsistencia = (params) => {
        //debugger;
        const url = 'http://127.0.0.1:8000/api/asistencia/update/'+id+"/";
                    ...
                    <Card.Body>
                        ...
                        <div>
                            <select className="form-select" value={hr_llegada} onChange={(e) => {
                                ...
                                <option value="A">Atraso: A</option>
